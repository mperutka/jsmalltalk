...
//tady nefunguje
jst.SequenceableCollection.constructor.prototype.reversed = function() {
	return this.reverse();
};
jst.SequenceableCollection.addMethod("reversed", "", "converting");
...
jst.String.constructor.prototype.reversed = function(){
	return jst.OrderedCollection.newFrom_(this).reversed().join("");
};
